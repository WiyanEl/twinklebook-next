        ...
        {!open && (
          <div className="flex items-center justify-start text-white">
            <button onClick={() => setOpen(!open)} className="relative top-[21px] left-[22px] md:top-[50px] md:left-[50px]">
              <Image src="/images/ronald-dan-vissi/mobile/icon-menu-toggle.png" alt="Picture of icon menu" width={25} height={17} className="md:w-[45px] md:h-[30px]" />
            </button>
          </div>
        )}
              ...
              <div className={`flex flex-col font-noto text-white mt-[36px] md:mt-[55px] mb-[32px] ${isClosing ? 'animate-close-menu-out' : ''}`}>
                <div className="overflow-hidden min-h-min opacity-0 animate-item-menu-in">
                  <Link href="#hero" className="flex items-center gap-1 relative left-[-18px] md:left-[-25px] hover:left-0 transition-all duration-300 uppercase" onClick={(e) => {
                    ...
                    <img src="/images/ronald-dan-vissi/mobile/arrow-right.png" className="w-[15px] md:w-[20px]" alt="" />
                ...
                <div className="overflow-hidden min-h-min mt-2.5 opacity-0 animate-item-menu-in" style={{ animationDelay: '0.45s' }}>
                  <Link href="#dresscode" className="flex items-center gap-1 relative left-[-18px] md:left-[-25px] hover:left-0 transition-all duration-300 uppercase" onClick={(e) => {
                    handleScrollDown(e)
