          ...
          <div className="fixed inset-0 z-50">
            ...
            <div className="relative z-20 flex items-center justify-center h-full">
              <div className="w-[290px] md:w-[416px] min-h-min rounded-[15px] md:rounded-[20px] shadow-[0px_8px_11.6px_0px_#0000008A] zoom-in">
                <div className="w-full h-[180px] md:h-[220px] rounded-tl-[15px] md:rounded-tl-[20px] rounded-tr-[15px] md:rounded-tr-[20px] bg-center bg-cover bg-no-repeat bg-[url('/images/ronald-dan-vissi/mobile/img-popup-hero.png')]"></div>
                <div className="relative w-full pt-[47px] md:pt-[62px] pb-[54px] rounded-bl-[15px] md:rounded-bl-[20px] rounded-br-[15px] md:rounded-br-[20px] font-cormorantgaramond text-black text-center bg-[#EBE8E5]">
                  <h6 className="text-xs md:text-lg font-normal leading-none md:uppercase">The Wedding of</h6>
                  <h2 className="font-slight text-[#A4753A] text-2xl md:text-[40px] leading-none font-normal mt-2.5">Ronald & Vissi</h2>
                  <h6 className="md:hidden text-xs md:text-base font-medium leading-[25px] md:leading-[31px] mt-2.5">Dear,</h6>
                  <h6 className="hidden md:block text-xs md:text-base font-medium leading-[25px] md:leading-[31px] mt-[22px]">Dear Mr. /Mrs. / Ms.</h6>
                  ...
                  <button onClick={() => handleOpen()} className="mx-auto mt-[17px] md:mt-[23px] w-[184px] md:w-[220px] h-[33px] md:h-[40px] bg-[#473B2F] rounded-[6px] md:rounded-[10px] flex items-center justify-center">
