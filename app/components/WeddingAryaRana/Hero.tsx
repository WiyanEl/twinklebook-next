...
export default function Hero({ data, isOpen, setIsOpen }: HeroProps) {
  ...
  return (
    <>
      <section id="hero" className="relative min-h-[120vh] bg-[url('/images/arya-dan-rana/mobile/bg-hero.png')] bg-cover bg-no-repeat bg-center">
        <div className="pointer-events-none absolute left-0 right-0 top-0 bottom-[-25%] z-[1] bg-[#DCCB9F]/20 mix-blend-multiply" />
        <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-[60vh] z-[2] bg-[linear-gradient(180deg,rgba(254,247,237,0)_0%,#FEF7ED_50%,#FEF7ED_100%)]" />
            ...
            <div className="relative z-20 flex items-center justify-center h-full">
              <div className="w-[290px] md:w-[416px] min-h-min rounded-[15px] md:rounded-[20px] shadow-[0px_8px_11.6px_0px_#0000008A] zoom-in">
                ...
                <div className="relative w-full pt-[28px] md:pt-[27px] pb-[28px] md:pb-[40px] rounded-bl-[15px] md:rounded-bl-[20px] rounded-br-[15px] md:rounded-br-[20px] font-cormorantgaramond text-black text-center bg-[#EBE8E5]">
                  ...
                  <h2 className="font-slight text-[#A4753A] text-2xl md:text-[32px] leading-none font-normal mt-3.5">Arya & Rana</h2>
        ...
        <div className="h-full relative z-10 text-center font-cormorantgaramond text-[#162F4E] pt-[177px]">
          <Image src="/images/arya-dan-rana/mobile/logo-singkatan-pengantin.png" alt="Picture of logo singkatan pengantin" width={122} height={122} className={`pointer-events-none mx-auto ${isOpen ? 'zoom-in' : ''}`} />
          <h4 className={`text-base md:text-[22px] font-medium uppercase mt-[39px] ${isOpen ? 'zoom-in' : ''}`}>the wedding of</h4>
          <div className="w-[222px] mt-[11px] mx-auto text-left">
            <h2 className={`font-bochan text-[#6D761C] text-[48px] leading-[62px] ${isOpen ? 'zoom-in' : ''}`}>Arya <br /> & Rana</h2>
          </div>
          <h4 className={`text-lg md:text-[22px] font-medium mt-[9px] ${isOpen ? 'zoom-in' : ''}`}>12 . 09 . 2026</h4>
        </div>
