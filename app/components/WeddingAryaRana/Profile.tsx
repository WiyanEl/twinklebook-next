...
export default function Profile({ data, isOpen }: Props) {
  ...
  return (
    <>
      <section id="profile" className="relative w-full min-h-screen bg-[url('/images/arya-dan-rana/mobile/bg-profile.png')] bg-cover bg-no-repeat pb-[25px]">
        ...
        <div className="relative z-[3] min-h-screen text-center font-cormorantgaramond text-[#001A3B] bg-[url('/images/arya-dan-rana/mobile/bg-kertas-profile.png')] bg-cover bg-no-repeat bg-center pt-[150px]">
        ...
        <Image src="/images/arya-dan-rana/mobile/img-kiri-tengah-profile.png" alt="Picture of gambar kiri tengah profile" width={277} height={277} className={`w-[135px] absolute z-[3] left-0 bottom-[256px] pointer-events-none`} />
