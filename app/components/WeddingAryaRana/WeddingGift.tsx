...
export default function WeddingGift({ data, isOpen }: Props) {
  ...
  return (
    <>
      <div className="bg-[url('/images/arya-dan-rana/mobile/bg-things-to-do.png')] md:bg-[url('/images/arya-dan-rana/dekstop/bg-wedding-gift.png')] bg-cover bg-no-repeat">
        <section id="wedding-gift" className="relative w-full min-h-min pt-[24px]">
          ...
          <div className="relative z-[3] h-full text-center font-cormorantgaramond text-[#001A3B] bg-[url('/images/arya-dan-rana/mobile/bg-kertas-wedding-gift.png')] md:bg-[url('/images/arya-dan-rana/dekstop/bg-kertas-wedding-gift.png')] bg-cover md:bg-contain bg-no-repeat bg-center pt-[168px] md:pt-[356px] pb-[182px] md:pb-[388px]">
            ...
            <p className="text-[15px] md:text-[22px] leading-[18px] md:leading-[26px] mt-8 md:mt-[60px] drop-shadow-[0px_5.41px_19.87px_#00000059] animate" data-animate="fade-up">
              Your presence and prayers <br /> are the greatest blessing to us.
            </p>
            <p className="text-[15px] md:text-[22px] leading-[18px] md:leading-[26px] mt-4 md:mt-[30px] drop-shadow-[0px_5.41px_19.87px_#00000059] animate" data-animate="fade-up">
