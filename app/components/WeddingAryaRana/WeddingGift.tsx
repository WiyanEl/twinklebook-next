...
export default function WeddingGift({ data, isOpen }: Props) {
  ...
  return (
    <>
      <section id="wedding-gift" className="relative w-full min-h-min bg-[url('/images/arya-dan-rana/mobile/bg-wedding-gift.png')] bg-cover bg-no-repeat overflow-hidden pt-[24px]">
